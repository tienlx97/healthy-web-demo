export const products = [
  {
    ...
    quantityAvailable: 2,
    category: "T-shirt",
    currentPrice: "260 375đ",
    sizes: ["xl", "l"],
    colors: ["#dd7a7a", "#6F3E18", "#7adb7d"],
    ...
    reviews: [
      {
        ...
        description: "<p>San pham that la tuyet voi,</p>",
        punctuation: 2,
      },
      {
        name: "John Doe",
  ...
  {
    id: "3",
    name: "Rau súp lơ sấy lạnh",
    price: 119.99,
    quantityAvailable: 2,
    category: "T-shirt",
    currentPrice: "90 000đ",
    sizes: ["xl", "l"],
    colors: ["#dd7a7a", "#6F3E18", "#7adb7d"],
